...
Modul 2: **Von der Sammlung über Modellierentscheidungen zum Diagramm – verstehen und erklären**

Einheit 0: **Willkommen und Ablauf**  
...
In Modul 2 wird das konzeptionelle Domänenmodell in Protégé mit CIDOC CRM umgesetzt. 
* ....
---
...
|--------|--------|------|
| 0 | Ablauf und Zielsetzung | x Min. |
| 1 | Methoden  und Workflows semantischer Modellierung | x Min. |
| 2 | Einführung in Protégé | x Min. |
| 3 | Modellieren mit CIDOC CRM mit einem Sammlungsbeispiel | x Min. |
...
* Ontologie zur Beschreibung von Ressourcen anwenden. (LZ-ID 03_007_0780)
