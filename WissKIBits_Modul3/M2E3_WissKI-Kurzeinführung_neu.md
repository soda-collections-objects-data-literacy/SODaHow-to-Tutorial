...
Beispielsweise lassen sich Zusammenhänge wie folgt beschreiben:
...
Solche Aussagen bilden zunächst ein Begriffsnetz, in dem Dinge, Personen, Orte und Ereignisse über Beziehungen miteinander verbunden sind.

Um diese Beziehungen systematisch nutzbar zu machen, werden Begriffe abstrahiert und als Klassen von Dingen beschrieben, etwa Person, Objekt, Ort oder Ereignis. 

Eigenschaften und Beziehungen zwischen ihnen werden eindeutig definiert. Dieses Vorgehen entspricht einem objektorientierten Modellierungsansatz, wie er in Ontologien wie dem CIDOC CRM verwendet wird.

Diese semantischen Bedeutungsaussagen formen schließlich einen Wissensgraphen – also ein Netzwerk miteinander verknüpfter Informationen. 
...
## Technische Grundlage: RDF und Tripel

Technisch basiert dieser Wissensgraph auf dem **Resource Description Framework (RDF)**, dem Standardmodell des Semantic Web. Informationen werden dabei als sogenannte Tripel gespeichert:
...
Objekte und Beziehungen werden dabei über eindeutige Identifikatoren (URIs) referenzierbar gemacht, sodass Daten institutionsübergreifend verknüpft und langfristig nachnutzbar bleiben.

Der WissKI Pathbuilder übersetzt ontologische Modelle direkt in solche RDF-Strukturen: Gruppen entsprechen Entitäten, Pfade definieren Beziehungen, und die daraus generierten Formulare erzeugen beim Erfassen automatisch konsistente Aussagen im Wissensgraphen.
